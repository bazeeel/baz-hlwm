...
{ --second background 1
      ...
      fg_colour=0xff0009, fg_alpha=0.6,
      x=35, y=35,
      radius=30, thickness=2,
...

{
      ...
      fg_colour=0xFF00D9, fg_alpha=0.6,
      x=35, y=135,
      radius=12, thickness=23,
      start_angle=0, end_angle=360
   },
...

{
      ...
      bg_colour=0x111111, bg_alpha=0.4,
      fg_colour=0x47B13E, fg_alpha=0.6,
      x=35, y=235,
      radius=12, thickness=23,
      start_angle=0, end_angle=360
   },
   ...
   },
{
      ...
      bg_colour=0x111111, bg_alpha=0.4,
      fg_colour=0xedda36, fg_alpha=0.6,
      x=35, y=335,
      radius=12, thickness=23,
      start_angle=0, end_angle=360
   },
...
{ --second background 4
      ...
      fg_colour=0xedda36, fg_alpha=0.6,
      x=35, y=335,
      radius=29, thickness=2,
      start_angle=-270, end_angle=88
  },

{
      name='upspeedf', arg='enp0s3', max=150,
      bg_colour=0x111111, bg_alpha=0.4,
      fg_colour=0xFF9401, fg_alpha=0.6,
      x=35, y=435,
      radius=12, thickness=23,
      start_angle=0, end_angle=360
   },
...
{
      name='downspeedf', arg='enp0s3', max=300,
      bg_colour=0x111111, bg_alpha=0.4,
      fg_colour=0x00FFFF, fg_alpha=0.6,
      x=35, y=535,
      radius=12, thickness=23,
      start_angle=0, end_angle=360
   },
...
{ --second background 7
      name='time', arg='%S', max=60,
      bg_colour=0x778899, bg_alpha=0.2,
